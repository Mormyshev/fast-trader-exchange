...
export default function OrderForm() {
    // Константы математики обмена (с макетов)
    ...
    return (
        /* 
          ...
          - Убран max-w-3xl и mx-auto, теперь форма занимает всю ширину своей колонки.
          - Внешние p-0 lg:p-0 гарантируют отсутствие лишних пустых зазоров по бокам на десктопе.
        */
        <div className="w-full antialiased select-none text-zinc-800 dark:text-zinc-100">
            {/* Главный пастельно-желтый кант-обертка из макета */}
            <div className="p-3 md:p-5 bg-[#FFFDE7] dark:bg-amber-950/20 rounded-[40px] shadow-xs">
                {/* Белое внутреннее тело формы (p-4 на мобильных, p-10 на десктопе) */}
                <div className="bg-white dark:bg-zinc-900 rounded-[32px] p-4 md:p-10 space-y-8 shadow-xs">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex flex-col text-right text-[11px] font-bold text-zinc-400 dark:text-zinc-500 pr-4">
                                <span>
                                    min.: {MIN_RUB.toLocaleString("ru-RU")} RUB
                                </span>
                                <span>
                                    max.: {MAX_RUB.toLocaleString("ru-RU")} RUB
                                </span>
                            </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Селектор крипты с оригинальной иконкой */}
                    ...
                    <div className="space-y-6 pt-2">
                        ...
                        <div className="flex items-start space-x-3 group cursor-pointer select-none">
                            ...
                            >
                                ...
                                <span className="underline decoration-zinc-400">
                                    возвратом средств в случае приостановки
                                    обмена по причине AML
                                </span>
                                , риск вычета комиссии сети из суммы обмена при
                                возврате осознаю.
                            </label>
                        </div>
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                className="w-full sm:max-w-xs bg-[#FFDD2D] hover:bg-[#e6c628] text-zinc-900 font-bold text-base py-4 rounded-full shadow-md active:scale-[0.99] transition-all flex items-center justify-center"
                            >
                                Продолжить
                            </button>
                        </div>
